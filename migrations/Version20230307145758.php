 ...
 */
final class Version20230307145758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD string DATETIME NOT NULL, DROP date, CHANGE reservation_heure reservation_heure DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD date DATE NOT NULL, DROP string, CHANGE reservation_heure reservation_heure TIME NOT NULL');
